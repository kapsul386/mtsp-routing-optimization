// v9/60_solver.cpp — phase orchestration for v9. Unlike v8, the candidate-set is integrated
// into the same phase (no separate 10_candidate_sets.cpp). Registered as "lkh-wrapper-v9".

// Successor to the modular v8 wrapper (see src/legacy/lkh_wrapper_v8/). Same module
