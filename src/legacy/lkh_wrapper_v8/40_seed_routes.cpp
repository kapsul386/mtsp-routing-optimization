// v8/40_seed_routes.cpp — building initial routes using the cluster model.
// Each salesman is assigned its own cluster; within the cluster, a route is built by greedy NN.
