// v8/00_common.cpp — shared infrastructure for the modular lkh-wrapper-v8:
// budget (SearchBudgetV5), types (CandidateSets, Coord), threshold constants, EdgeFreqMap.
// Included first in mtsp_lkh_wrapper_v8.cpp so that all downstream fragments
// can use the types and helpers defined here.
