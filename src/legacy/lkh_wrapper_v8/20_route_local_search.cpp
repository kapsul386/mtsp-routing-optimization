// v8/20_route_local_search.cpp — local search within a single route:
// 2-opt with candidate-list filtering, double-bridge kick, ILS loop, completion logic.
// Templated on the distance functor for use in both TSP and mTSP contexts.
