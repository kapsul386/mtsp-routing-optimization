// v16: third of the A/B series v14--v17 on the v12 pipeline. Same parameter surface as v14/v15
// with another iteration of metadata and parameter tweaks. Retained for compatibility with
// CSV references; not a milestone version. Superseded by v18 / ALNS-mTSP. Registered as "lkh-wrapper-v16".
...
// Repair-stats for v16 (same structure as v14/v15; metadata namespaced per version).
...
// v16: third A/B variant on the v12 pipeline, minor parameter tweak.
// Semantically close to v15; registered as a separate solver only for
// CSV compatibility. Registered as "lkh-wrapper-v16".
