// v17: last of the A/B series v14--v17 on the v12 pipeline. Direct predecessor of v18
// (which added polar-sweep seed). Final iteration of the "tweak v12 in-place" line;
// the next milestone (v18) introduces new ideas. Registered as "lkh-wrapper-v17".
...
// Repair-stats for v17 (same structure as v14/v15/v16).
struct RouteRepairStatsV17 {
    double before_sum = 0.0;
    double after_sum = 0.0;
    int attempts = 0;
    int accepted = 0;
    long long insert_loop_us = 0;
    long long cleanup_loop_us = 0;
};

// v17: final A/B variant on the v12 pipeline before the transition to v18 (polar-sweep seed).
// Carries the final parameter tweaks that v18 inherits. Registered as "lkh-wrapper-v17".
class LkhWrapperSolverv17 : public Solver {
public:
...
static bool reg_lkh_mtsp_v17 = (SolverFactory::RegisterSolver("lkh-wrapper-v17", []() {
    return std::make_unique<LkhWrapperSolverv17>();
}),
                                true);
