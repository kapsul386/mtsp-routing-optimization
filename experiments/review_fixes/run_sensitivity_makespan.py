...
Запускает alns_minsum (lkh_v21_minmax) на трёх инстансах N=100K, m=5
...
Артефакт: experiments/review_fixes/sensitivity_makespan_results.csv
"""
...
OUTPUT_CSV = ROOT / 'experiments' / 'review_fixes' / 'sensitivity_makespan_results.csv'
SEED = 1
