...
$resultsCsv = Join-Path $repoRoot "data\results\v4_v7_baseline_overnight_results.csv"
$summaryCsv = Join-Path $repoRoot "data\results\v4_v7_baseline_overnight_summary.csv"
$reportMd = Join-Path $repoRoot "data\results\v4_v7_baseline_overnight_report.md"
$progressJson = Join-Path $repoRoot "data\results\v4_v7_baseline_overnight_progress.json"
