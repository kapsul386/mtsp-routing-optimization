...
$resultsCsv = Join-Path $resultsDir "v4_v7_baseline_long_run_results.csv"
$summaryCsv = Join-Path $resultsDir "v4_v7_baseline_long_run_summary.csv"
$progressJson = Join-Path $resultsDir "v4_v7_baseline_long_run_progress.json"
$reportMd = Join-Path $resultsDir "v4_v7_baseline_long_run_report.md"
